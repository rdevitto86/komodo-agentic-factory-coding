...
func Table() []Case {
	return []Case{
		...
		// 3. A host or toolkit config is never written.
		write("the Claude home", "~/.claude/settings.json", true, "host or toolkit config"),
		write("the Claude config file", "~/.claude.json", true, "host or toolkit config"),
		write("the Codex home", "~/.codex/config.toml", true, "host or toolkit config"),
		write("the machine overlay", "~/.komodo/config.json", true, "host or toolkit config"),
		write("the git config", ".git/config", true, "host or toolkit config"),
		write("a git hook", ".git/hooks/pre-commit", true, "host or toolkit config"),
		write("a shipped binary", "bin/komodo-darwin-arm64", true, "host or toolkit config"),
		bash("chmod a git hook", "chmod +x .git/hooks/pre-push", "feat/x", true, "host or toolkit config"),
		bash("copy into the Claude home", "cp secret ~/.claude/x", "feat/x", true, "host or toolkit config"),
		bash("touch the machine overlay", "touch ~/.komodo/config.json", "feat/x", true, "host or toolkit config"),

		// 4. A commit message never carries a trailer.
