---
name: standards-aws
description: AWS conventions — IAM least privilege, VPC/networking basics, service-selection principles. Load before writing or reviewing IAM policies, VPC/subnet/security-group config, or choosing which AWS service class to use.
