...
description: Read/write directive shared by the two mutable work records — BACKLOG.md and CHANGELOG.md. Not their format; see backlog and changelog for that.
