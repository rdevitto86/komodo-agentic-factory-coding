...
description: Azure conventions — RBAC/managed-identity least privilege, VNet/subnet/NSG networking basics, service-selection principles. Load before writing or reviewing Azure RBAC role assignments, VNet/subnet/NSG config, or choosing which Azure service class to use.
