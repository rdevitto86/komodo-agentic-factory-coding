...
description: Audit CHANGELOG.md against git history and write-changelog's rules — missing/backfillable entries, format inconsistencies, version-bump and tag misalignment — filed as BACKLOG.md stories. Pass --report to skip the write.
