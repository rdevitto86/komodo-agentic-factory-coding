---
name: standards-zig
description: Zig conventions — allocator discipline, error unions, comptime, build.zig/build.zig.zon. Load before writing or reviewing any .zig, build.zig, or build.zig.zon file.
