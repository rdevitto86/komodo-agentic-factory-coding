...
**After this, you may need:** `/add-route` to register handlers, `/api-audit` to confirm the skeleton conforms to `~/.claude/agents/software-engineer/api/blueprint.md`, `/git-flow` for branch and PR conventions.
