...
Covers structured logging correlation, metrics, distributed tracing, and health checks. Log levels, required fields, and what not to log are in `~/.claude/standards/logging.md` — this document covers the instrumentation layer.
...
- Never log tokens, session data, or PII. See `~/.claude/standards/logging.md`.
