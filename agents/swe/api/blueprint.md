...
| R6 | Auth, CSRF, and idempotency applied per route protection level | `~/.claude/standards/security.md`, `~/.claude/agents/swe/api/design.md` §2 | all |
...
| P3 | Schema changes ship as paired `.up.sql` / `.down.sql` migrations | `~/.claude/agents/swe/db/sql.md`, `~/.claude/standards/stack.md` §7 | services with a database |
