...
def cmd_release(args: argparse.Namespace) -> int:
    """komodo release: tag the newest released changelog heading if the tag is missing."""
    root = repo_root()
    config = load_config(root)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    release = sub.add_parser("release", help="tag the newest released changelog version")
