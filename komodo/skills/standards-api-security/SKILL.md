...
description: Authn, authz, input validation, secrets, and transport rules for an exposed surface.
globs: ["**/api/**", "**/auth/**", "**/controllers/**", "**/crypto/**", "**/handlers/**", "**/middleware/**", "**/routes/**"]
roles: [reviewer]
---
