---
name: standards-rust
description: Rust: ownership, error types, traits, unsafe, and the standard library first.
globs: ["**/*.rs", "**/Cargo.toml"]
---
...
- **Tier definitions, merge/release gates, and coverage floors are owned by the sdlc standard** (100% the target on new code, 85% the hard minimum, 100% required on SDKs/shared libraries and security-critical paths) — this section covers Rust mechanics only.
