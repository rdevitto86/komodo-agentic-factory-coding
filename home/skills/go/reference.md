...
One endpoint end to end. Copy the **structure**, not the names — `widget`/`thing` stand in for this API's domain. Every example is comment-free by design.

## Bone to Go expression
