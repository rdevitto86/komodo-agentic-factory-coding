---
name: hardware
description: Hardware and robotics: circuit review, PCB layout, BOM, robotics integration.
user-invocable: false
---

# Hardware

Physical design and integration. **Firmware code rules live in the `cpp` skill** — this covers everything upstream of it.
