...
- **5. References** — pointer table to what exists: `docs/prd.md`, `docs/sdd.md`, `BACKLOG.md`, `CHANGELOG.md`, `openapi.yaml` or equivalent contract file. List only files present in this repo. **Never list `docs/adr/`** — design decisions live in SDD §7, per `docs`.
