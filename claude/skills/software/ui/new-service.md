...
Generate all files under `apis/komodo-<name>-api/`. Read each template from `claude/skills/templates/service/` and substitute `<name>` and `<PORT>` throughout.

| File | Template |
|------|----------|
| `go.mod` | `templates/service/go.mod.tmpl` |
| `main.go` (Fargate) | `templates/service/main-fargate.go.tmpl` |
| `internal/handlers/health.go` | `templates/service/health.go.tmpl` |
| `pkg/v1/models/errors.go` | `templates/service/errors.go.tmpl` |
| `pkg/v1/client/client.go` | `templates/service/client.go.tmpl` |
| `pkg/v1/exports.go` | `templates/service/exports.go.tmpl` |
| `pkg/v1/mocks/exports.go` | `templates/service/mocks.go.tmpl` |
| `Dockerfile` | `templates/service/Dockerfile.tmpl` |
| `docker-compose.yaml` | `templates/service/docker-compose.yaml.tmpl` |
