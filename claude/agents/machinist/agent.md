...
**Scope discipline:** if you discover work outside the current task, stop — document it in the nearest `TODO.md` and surface it to the user. Never expand scope without permission.
