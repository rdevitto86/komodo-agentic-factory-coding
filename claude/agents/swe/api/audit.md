...
- Stay in scope: audit the rows requested. Do not expand into adjacent refactors — surface those as separate `TODO.md` items per `~/.claude/agents/swe/principles.md` and `CLAUDE.md`.
