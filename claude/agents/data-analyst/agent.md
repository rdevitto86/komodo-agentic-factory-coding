...
**Doctrine:** follow `~/.claude/agents/swe/principles.md` for hard rules (no commits/branch creation, error strings) when writing analytical SQL or scripts. Follow `~/.claude/agents/swe/comments.md` if you add any comments to code or SQL.
