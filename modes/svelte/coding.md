...
Colocate test files per `~/.claude/modes/ts/coding.md`. Component tests use `@testing-library/svelte`.
...
See `~/.claude/modes/ts/coding.md §4` for full SvelteKit test conventions.
